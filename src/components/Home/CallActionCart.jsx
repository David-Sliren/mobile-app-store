...
const CallActionCart = () => {
  return (
    <section className="py-20 border-t border-zinc-900" id="contact">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          transition={{ duration: 0.5 }}
          className="flex flex-col items-center p-12 rounded-[3rem] bg-gradient-to-b from-zinc-900 to-zinc-950 border border-zinc-800 relative overflow-hidden"
        >
